...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO `users_table`(`user_id`, `user_name`, `user_email`,`user_verifycode`, `isactive`, `user_password`) VALUES 
   (NULL,'$user_name','$user_email','$user_verifycode','$isactive','$user_password')";
      ...
      <div class="container d-flex justify-content-center">
         <form action="" method="post" style="width:50vw; min-width:300px;">
            <div class="row mb-3">
               ...
               <input type="text" class="form-control" name="user_verfiycode" >
            </div>
